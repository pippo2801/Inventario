          ...
          <div className="relative">
            ...
            {showNotifMenu && (
              <>
                ...
                <div className="absolute right-0 sm:right-0 z-50 mt-2 w-[min(320px,calc(100vw-16px))] max-w-[calc(100vw-16px)] overflow-hidden rounded-2xl border border-[#d9d2c8] bg-[#fbf9f5] shadow-[0_18px_50px_rgba(42,38,34,0.16)]">
